...
// https://fonts.googleapis.com/css?family=Allura|Red+Hat+Display:500,700
...
// Custom logo markup
// .get_bloginfo( 'name' )
// changed to $logo = '<span class="logo-default">' . 'New Golden Gate' .'</span>';
function bento_get_custom_logo() {
	$logo = '<span class="logo-default">' . 'New Golden Gate' .'</span>' . '<div class="logo23"><span class="logo-default2">' . '(617) 338-7721' .'</span>' . '<br><span class="logo-default3">' . 'MONDAY - SUNDAY | 11AM - 4AM' .'</span></div>';
